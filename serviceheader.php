    ...
    <div class="d-flex align-items-center ms-auto">
      <nav id="navmenu" class="navmenu me-3">
        <ul class="d-flex align-items-center gap-4">
          <li><a href="servicehome.php" class="active">Home</a></li> 
          <li class="dropdown">
            <a href="#"><span>Service</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              <li><a href="serviceRequest.php">View Requests</a></li>
                <a href="serviceBooking.php"><span>View Bookings</span></a>
              </li>
            </ul>
          </li>
          <li><a href="serviceFeedback.php">Feedbacks</a></li> 
